...
import be.enceladus.scan2ereader.core.ocr.model.WhiteSpace;
import be.enceladus.scan2ereader.core.ocr.model.Word;
import be.enceladus.scan2ereader.core.processing.corrections.AngleCorrectionQuadrilateral;
...
import static be.enceladus.scan2ereader.core.ocr.model.Side.*;
import static be.enceladus.scan2ereader.core.utils.TimeUtils.formatMillis;
            ...
            for (TextZone textZone : textZones) {
                ...
                if (expanded) {
                    if (textZone instanceof Word) {
                        if (Objects.equals(textZone.getMarkColor(), LEFT.getColor())) {
                            graphics2D.draw(LEFT.getCorrectedCollisionRectangle(textZone));
                        } else if (Objects.equals(textZone.getMarkColor(), RIGHT.getColor())) {
                            graphics2D.draw(RIGHT.getCorrectedCollisionRectangle(textZone));
                        } else if (Objects.equals(textZone.getMarkColor(), TOP.getColor())) {
                            graphics2D.draw(TOP.getCorrectedCollisionRectangle(textZone));
                        } else if (Objects.equals(textZone.getMarkColor(), BOTTOM.getColor())) {
                            graphics2D.draw(BOTTOM.getCorrectedCollisionRectangle(textZone));
                        } else {
